    ...
    return (
      <div className="bg-white/90 backdrop-blur-sm border-0 shadow-lg shadow-orange-500/5 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300 rounded-xl overflow-hidden">
        ...
        <div className="p-3 space-y-2">
          ...
          <div className="jp-bg-blue-pattern mt-3 rounded-lg border border-blue-200/60 p-2.5 ring-1 ring-blue-100/50">
            <div className="flex items-center gap-1.5">
              <div className="rounded-full bg-blue-100 p-1">
                <Shield className="h-3 w-3 text-blue-700" strokeWidth={2.5} aria-hidden />
              </div>
              <p className="text-xs font-medium text-blue-900">Your safety is our priority</p>
            </div>
            <p className="mt-0.5 text-xs text-blue-800/90">Secure payment processing and dispute resolution</p>
          </div>
        </div>
      </div>
    );
