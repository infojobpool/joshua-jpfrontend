  ...
  if (variant === "mobile") {
    ...
    return (
      ...
      >
        ...
        <div
          ref={mobileScrollRef}
          className="w-full min-w-0 max-w-full overflow-x-scroll overflow-y-hidden overscroll-x-contain touch-auto pb-2 [overflow-anchor:none] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="flex justify-center">
            <div
              ...
              className="max-w-full overflow-x-auto overscroll-x-contain touch-auto scroll-auto pb-6 pl-12 pr-12 md:pl-14 md:pr-14 [overflow-anchor:none] scrollbar-hide"
              style={{
                scrollbarWidth: "none",
