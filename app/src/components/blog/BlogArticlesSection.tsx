...
export function BlogArticlesSection() {
  ...
  if (loading) {
    return (
      <section className="w-full bg-sky-50/50 py-8 dark:bg-slate-900/40 md:py-11">
  ...
  return (
    <section className="w-full bg-sky-50/50 py-8 dark:bg-slate-900/40 md:py-11">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <ul className="mt-6 grid list-none gap-5 p-0 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
          {posts.map((post) => (
