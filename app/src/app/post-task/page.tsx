...
//           // Store both category_id and category_name
//           setCategories(
...
export default function PostTaskPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <Dialog open={showConfirmPost} onOpenChange={setShowConfirmPost}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Confirm Task Posting</DialogTitle>
            <DialogDescription>
              Please review your task budget details before posting.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={confirmPostSubmission} disabled={isSubmitting}>
