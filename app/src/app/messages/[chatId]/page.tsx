  ...
  return (
    <div className="flex h-screen flex-col bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 overflow-hidden fixed inset-0 z-50">
      ...
      <ScrollArea className="flex-1 bg-gradient-to-b from-slate-50 via-blue-50/20 to-white min-h-0">
        <div className="px-8 py-6 space-y-4 h-full max-w-4xl mx-auto">
      ...
      <div className="bg-white/95 backdrop-blur-xl border-t border-gray-200/30 p-6 flex-shrink-0 shadow-2xl relative z-10">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1 relative">
              <Input
                ...
                className="w-full border-2 border-gray-200/50 focus:border-blue-500 rounded-3xl px-6 py-5 bg-gray-50/60 focus:bg-white pr-20 text-lg font-medium shadow-xl transition-all duration-200 backdrop-blur-sm"
                disabled={sending}
              />
            ...
            <Button 
              ...
              className="p-5 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-800 text-white rounded-3xl disabled:opacity-50 shadow-2xl transition-all duration-200 transform hover:scale-105"
            >
              {sending ? (
