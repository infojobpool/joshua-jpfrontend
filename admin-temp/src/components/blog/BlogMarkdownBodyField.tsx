...
const PREVIEW_MD_CLASS =
  ...
  "[&_hr]:my-6 [&_hr]:border-slate-200 [&_img]:my-4 [&_img]:mx-auto [&_img]:block [&_img]:h-auto [&_img]:w-full [&_img]:max-w-full [&_img]:max-h-[min(88vh,920px)] [&_img]:rounded-md [&_img]:object-contain";
